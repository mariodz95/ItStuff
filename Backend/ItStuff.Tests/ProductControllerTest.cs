...
namespace ItStuff.Tests
{
    public class ProductControllerTest
    {
        ...
        public async void Create_ShouldReturnNewProduct()
        {
            ...
            var id = Guid.NewGuid();
            var name = "Name 1";
            IProductModel newProduct = new ProductModel() { Id = id, Name = name, Description = "Desc 1", Price = 1, Location = "Location 1" };
            var productViewModel = new ProductViewModel() { Name = "Name 1", Description = "Desc 1", Price = 1, Location = "Location 1" };
            IProductModel tt = new ProductModel() {  Name = name, Description = "Desc 1", Price = 1, Location = "Location 1" };
